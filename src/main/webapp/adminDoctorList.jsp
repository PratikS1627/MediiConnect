...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="AdminHome.jsp"><b>MediConnect</b></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownRecp" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Receptionist
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownRecp">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownWorker" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Worker
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownWorker">
                        ...
                        <tbody>
                            <tr class="row100 body">
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
<a href="deleteDoctor.jsp?id=<%=rs.getInt("id")%>" onclick="return confirm('Are you sure you want to delete this doctor?');">Delete</a>
